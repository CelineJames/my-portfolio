...
export default function Hero() {
  ...
  return (
    <div className="border border-red overflow-hidden relative flex flex-col-reverse md:flex-row justify-center items-center h-screen bg-primary dark:bg-secondary">
